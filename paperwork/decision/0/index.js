...
export default function Decision0({navigation,route}){
    ...
    const imagePathViolator = `${violator_docID}/sign/sign.png`
    const storageRef = ref(storage, imagePath);
    const storageRef2 = ref(storage,imagePathViolator)
  ...
  const [sign2,setSign2]=useState()
    ...
    return(
        <ScrollView style={{backgroundColor:"white",flex:1,paddingTop:35,paddingHorizontal:10}}>
            ...
            <TextInput style={{top:6}} placeholderTextColor="gray" placeholder="..........." onChangeText={text=>setID(text)}/>
            </View>
      ...
      />
            ...
            <View style={{flexDirection:"row",justifyContent:"space-between",marginTop:20}}>
                <View style={{alignItems:"center"}}>
                    ...
                    {/* Police Sign */}
                    {sign2? (
                    <Image source={{uri: downloadURL2}} style={{width:100,height:100}}/>
            ...
            <TouchableOpacity onPress={handle_decision}  style={{backgroundColor:"#E8ECF4",alignItems:"center",marginHorizontal:40,paddingVertical:20,borderRadius:10,marginTop:50}}>
